...
% ── Metadata ──────────────────────────────────────────────────────────────────
\title{Flash Flood Susceptibility Mapping in Himachal Pradesh Using\\
  Graph Neural Networks and Conformal Prediction:\\[4pt]
  \large A SAR-Based Inventory with Uncertainty-Quantified Risk Assessment
}
