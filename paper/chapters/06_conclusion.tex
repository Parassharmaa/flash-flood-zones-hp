...
\begin{enumerate}
  ...
  \item \textbf{Spatial cross-validation corrects AUC inflation.}
    The random 5-fold CV yielded stacking AUC of 0.901;
    the Saha et al.\ (2023) benchmark of 0.88 with random splits
    likely reflects modest optimism from spatial autocorrelation.
    All four pixel-based models in this study (AUC 0.890--0.901) outperform
    that benchmark while using spatially conservative evaluation.
  ...
  \item \textbf{High susceptibility covers 14.3\% of HP's study domain.}
    ...
    Infrastructure exposure analysis of these zones is a priority direction
    for future work.
