...
\paragraph{Gap 1 --- No comprehensive peer-reviewed ML study for HP.}
Only one peer-reviewed ML paper targets HP specifically:
...
A CNN U-Net study (Research Square, 2025) remains a non-peer-reviewed preprint.
The absence of a comprehensive, peer-reviewed benchmark for HP represents a clear
publication gap.
...
\begin{enumerate}
  ...
  \item \textbf{State-wide risk assessment with infrastructure overlay.}
    We produce the first comprehensive, peer-reviewed flash flood susceptibility map
